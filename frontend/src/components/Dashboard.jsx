...
export default function Dashboard() {
  ...
  useEffect(()=>{
    async function fetchUserPreviousOrder() {
      try {
    ...
    <>
      <div className="container-fluid login-bg-container ">
        <div className="container justify-content-center align-self-start mt-5 ">
          <div className="card border-0 p-1 m-4 d-flex justify-content-center align-items-center align-self-start mt-5 " style={{ background:"transparent" }} >
            <h3 className="text-black shadow-lg-info">
              {message} {user.firstName} 
            </h3>
          </div>

          <Order userOrderInfo={userOrderInfo}/>

          {userOrderInfo && 
            <div className="container d-flex mt-4 justify-content-center align-item-center">
            <div className="card p-4 shadow-lg " style={{ width: "250px",background:"#eae9e7" }}>
